...
# **JENKINS{Continuous Integration, Continuous Deployment tool}**
...
variable stores the values and keep changing. a=13
...
create a ci job -- > Build Triggers -- > build periodically -- > * * * * * -- > save commit the changes in GitHub then wait for 1 min.
